...
SELECT id, small_integer FROM example_table2 WHERE small_integer > '25';  -- 괜찮음
...
INSERT INTO example_table2 (id, variable_length_string) VALUES
  ...
  (null, '40'),
  (null, '50');
SELECT id, variable_length_string FROM example_table2 WHERE variable_length_string > 25;  -- 타입캐스팅 오버헤드 발생
SELECT id, variable_length_string FROM example_table2 WHERE variable_length_string > '25'; -- 문자열 대소 비교에서도 시스템 내부적 타입캐스팅 발생
